...
Now let's get cooking! `r emo::ji("fried_egg")`
...
To finish this little gem, click the **Schedule** button and establish a schedule for your ETL (and resulting pin) to refresh.  Now you can point your customer-facing data analysis at this pin to always have a fresh source of data behind it. Dazzling! `r emo::ji("sparkles")`
