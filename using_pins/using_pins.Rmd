...
In the next section, you’ll learn how to `pin` your first resource to RStudio Connect. From there, you can check out this website <https://pins.rstudio.com> for further inspiration on how to use `pins` to make your day-to-day life as a data scientist easier.
