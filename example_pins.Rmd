...
![Connections pane after registering rsconnect board](using_pins/connections_pane.png)
...
![Oh joy! The dataset is pinned to Connect!](using_pins/pinned_to_connect.png)
...
![Access permissions and controls in Connect](using_pins/pin_access_controls_and_vanityURL.png)
...
![Empty environments pane](using_pins/empty_environments_pane.png)
...
![Code in Connect to retrieve your pin](using_pins/retrieval_code.png)
...
![Deployment error message](using_pins/deployment_error.png)

Stop cursing! This is one time that the error message is good.  You've done it all right so far! This error is telling us that Connect can't find an API key.  "API keys again? Didn't we do that already?"  Yes, we did that for the RStudio IDE session.  But not for Connect.  Easy to fix.  

Jump over to Connect and open your sad, un-rendered content.  
![See the "This output has not been rendered" message in Connect](using_pins/sad_unrendered_content.png)
