...
1. Install a current version of `pins`{.R}.  The `pins`{.R} package is available on CRAN, and was at version `r packageVersion("pins")` at the time of this writing. Install `pins`{.R} with  \hyphenpenalty 10000 `install.packages("pins")`{.R}. 

Got all that? Let's get cooking! `r if(knitr::is_html_output()) emo::ji("fried_egg") else knitr::include_graphics("template_files/emoji_fried_egg.png")`
