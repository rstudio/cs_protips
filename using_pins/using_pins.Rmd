...
output:
  pdf_document:
    ...
    includes:
      in_header: "using_pins/template_files/header.tex"
  html_document:
    toc: true
    toc_float: true
    css: "using_pins/template_files/style.css"
    includes:
      #to knit locally, change path to using_pins/template_files
      in_header: "using_pins/template_files/header.html"
      after_body: "using_pins/template_files/footer.html"
...
1. Be running RStudio Connect v 1.7.8 or higher.^[ If you're not yet at this version but are keen to get started with `pins`, talk to your R Admin and refer to https://docs.rstudio.com/connect/admin/server-management/#upgrading if you are at an earlier version]
...
4. Tell knittr to exit the knitting process if these environment variables don't exist by placing this code at the top of your document. This will save you from getting scary error messages that will stop your content from deploying or rendering altogether. It's not necessary, but it will be helpful later on.
``` { r warning}
