...
output:
  ...
  html_document: 
    css: !expr here::here("using_pins/template_files/style.css")
    includes:
      before_body: !expr here::here("using_pins/template_files/header.html")
      after_body: !expr here::here("using_pins/template_files/footer.html")
